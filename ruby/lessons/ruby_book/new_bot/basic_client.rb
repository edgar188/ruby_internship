...
hamo = Bot.new(name: 'Hamo', data_file: 'bot_data')
gago = Bot.new(name: 'Gago', data_file: 'bot_data')

r = hamo.greeting
30.times do
  puts "#{hamo.name} said: " + r
  r = gago.response_to(r)
  puts "#{gago.name} said: " + r
  r = hamo.response_to(r)
end
