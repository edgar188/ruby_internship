...
function add_article_art() {
  let code_block = `<div>
    ...
    <input type="text" placeholder="Add a comment..." name=article[article_arts_attributes][${new_article_arts_count}][article_art_comments_attributes][${new_article_arts_count}][body]> <br/>
